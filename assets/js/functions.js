...
function password_change(){
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/password_change.php',
		method: 'post',
		cache: false,
		data:
		{
...
function profile_update(){
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/profile_update.php',
		method: 'post',
		cache: false,
		data:
		{
...
function profile_updatePic(src)
{
    ...
    var ft = new FileTransfer();
        ft.upload(imageURI, encodeURI ("http://apemalaysia.net/resident/api/profile_pic.php"), win, fail, options);
...
function password_retrieve()
{
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/retrieve_password.php',
		method: 'post',
		cache: false,
		data:
		{
...
function password_sendSMS(mobile, password)
{
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/iteksi/api/server_receiver.php',
		method: 'get',
		cache: false,
		data:
		{
...
function leave_checkPage()
{
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/leave_counter.php',
		method: 'post',
		cache: false,
		data:
		{
...
{	
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/leave_list.php',
		method: 'post',
		cache: false,
		data:
		{
...
function leave_register(){
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/leave_register.php',
		method: 'post',
		cache: false,
		data:
		{
...
function evaluation_register(){
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/evaluation_register.php',
		method: 'post',
		cache: false,
		data:
		{
...
function ci_submit(){
	...
	$.ajax(
	{
		...
		url: 'http://apemalaysia.net/almushin/api/attendance_log.php?lang='+ ci_latitude +'&long='+ ci_longitude +'&company='+ ci_company +'&user='+ userIndex + '&description='+ ci_description,
		data:
		{
...
//alert(uid);
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/sale_summarylist.php',
		method: 'post',
		cache: false,
		data:
		{
...
{	
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/sale_counter.php',
		method: 'post',
		cache: false,
		data:
		{
...
function onPrint(index)
{
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/print_status.php',
		method: 'post',
		cache: false,
		data:
		{
...
function onDelete()
{
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/delete_sale_list.php',
		method: 'post',
		cache: false,
		data:
		{
...
function edit_customer_details(){
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/customer_profile_update.php',
		method: 'post',
		cache: false,
		data:
		{
...
function customerDelete()
{
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/customer_delete.php',
		method: 'post',
		cache: false,
		data:
		{
...
function sale_register(){
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/sale_register.php',
		method: 'post',
		cache: false,
		data:
		{
...
function clearSalesInfo(){
	...
	$.ajax(
	{
		url: 'http://apemalaysia.net/osafe/api/sale_register1.php',
		method: 'post',
		cache: false,
		data:
		{
...
function loadproduct()
{
	$.ajax(
	{
	    url: 'http://apemalaysia.net/osafe/api/product_category.php',
		method: 'get',
		cache: false,
	})
	.done(function(response)
	...
	$.ajax(
	{
	    url: 'http://apemalaysia.net/osafe/api/color.php',
		method: 'get',
		cache: false,
	})
	.done(function(response)
...
function loadevaluation()
{
	...
	//	url: 'http://localhost/kelakar/api/video_details.php?id=1',
	    url: 'http://apemalaysia.net/osafe/api/status_category.php',
		method: 'get',
		cache: false,
	})
	.done(function(response)
